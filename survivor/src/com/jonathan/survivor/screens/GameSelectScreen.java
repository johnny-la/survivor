...
public class GameSelectScreen extends Screen
{
	...
	public void resize(int width, int height)
	{
		...
		gameSelectBackground.setPosition(stage.getWidth()/2 - gameSelectBackground.getWidth()/2 + BACKGROUND_X_OFFSET, 
										 stage.getHeight()/2 - gameSelectBackground.getHeight()/2 + BACKGROUND_Y_OFFSET);
	...
	public void fadeIn()
	{
		...
		//Move the table down
		table.addAction(Actions.moveBy(0, -40));
		//Move the table back up in the given amount of time
		table.addAction(Actions.moveBy(0, 40, 0.75f, Interpolation.exp5Out));
	}
