...
public class WorldSelectScreen extends Screen
{
	...
	{	
		...
		System.out.println("WorldSelectScreen.createButtonList(): Number of buttons to create: " + len);
	...
	private void deleteProfile(int index)
	{
		...
		System.out.println("WorldSelectScreen.deleteProfile(): Delete profile with index: " + selectedProfileId);
	...
	public void resize(int width, int height)
	{
		...
		worldSelectBackground.setPosition(stage.getWidth()/2 - worldSelectBackground.getWidth()/2 + BACKGROUND_X_OFFSET, BACKGROUND_Y_OFFSET);
