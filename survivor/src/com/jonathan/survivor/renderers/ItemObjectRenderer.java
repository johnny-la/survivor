...
public class ItemObjectRenderer 
{
	...
	public void draw(ItemObject itemObject, boolean transparent)
	{
		...
		{
			//Play the item's FLY animation. Second and third arguments specify how much time the tree has been idle, third indicates we want to 
		...
		{
			//Play the item's GROUNDED animation. Second and third arguments specify how much time the tree has been idle, third indicates we want to 
			//loop the animation, and last is an array which stores animation events that are delegated.
